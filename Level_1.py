	...
	if 155>=boll_y>=153:
		if obj34_brok:
			if  69 >= boll_x and boll_x+15 >= 29 :
				...
				obj34_brok = False
		if obj35_brok:
			if 111 >= boll_x and boll_x+15 >= 71 :
				obj35_x = 550
				obj35_y = 100
				broken = 1
				obj_count += 1
				obj35_brok = False
		if obj36_brok:
			if 153 >= boll_x and boll_x+15 >= 113 :
				obj36_x = 550
				obj36_y = 100
				broken = 1
				obj_count += 1
				obj36_brok = False
		if obj37_brok:
			if 195 >= boll_x and boll_x+15 >= 155 :
				obj37_x = 550
				obj37_y = 100
				broken = 1
				obj_count += 1
				obj37_brok = False
		if obj38_brok:
			if 237 >= boll_x and boll_x+15 >= 197 :
				obj38_x = 550
				obj38_y = 100
				broken = 1
				obj_count += 1
				obj38_brok = False
		if obj39_brok:
			if 279 >= boll_x and boll_x+15 >= 239 :
				obj39_x = 550
				obj39_y = 100
				broken = 1
				obj_count += 1
				obj39_brok = False
		if obj40_brok:
			if 321 >= boll_x and boll_x+15 >= 281:
				obj40_x = 550
				obj40_y = 100
				broken = 1
				obj_count += 1
				obj40_brok = False
		if obj41_brok:
			if 363 >= boll_x and boll_x+15 >= 323 :
				obj41_x = 550
				obj41_y = 100
				broken = 1
				obj_count += 1
				obj41_brok = False
		if obj42_brok:
			if 405 >= boll_x and boll_x+15 >= 365 :
				obj42_x = 550
				obj42_y = 100
				broken = 1
				obj_count += 1
				obj42_brok = False
		if obj43_brok:
			if 447 >= boll_x and boll_x+15 >= 407 :
				obj43_x = 550
				obj43_y = 100
				broken = 1
				obj_count += 1
				obj43_brok = False
		if obj44_brok:
			if 489 >= boll_x and boll_x+15 >= 449 :
				obj44_x = 550
				obj44_y = 100
				broken = 1
				obj_count += 1
...
#Четвертый ряд
	if boll_y<155 and boll_y+15>140:
		if obj34_brok:
			if boll_x == 69:
				broken_x = 1
				obj_count += 1
...
#Третий ряд
	if boll_y<137 and boll_y+15>122:
			if obj23_brok:
				if boll_x == 69:
					broken_x = 1
					obj_count += 1
...
#Второй ряд
	if boll_y<119 and boll_y+15>104:
			if obj12_brok:
				if boll_x == 69:
					broken_x = 1
					obj_count += 1
...
#Первый ряд
	if boll_y<101 and boll_y+15>86:
			if obj1_brok:
				if boll_x == 69:
					broken_x = 1
					obj_count += 1
